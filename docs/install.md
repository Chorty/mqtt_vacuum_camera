...
[![Open HACS repository in Home Assistant](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=chorty&repository=mqtt_vacuum_camera&category=integration)
...
![Screenshot 2023-08-12 at 17 06 17](https://github.com/chorty/valetudo_vacuum_camera/assets/82227818/4abdf05a-eb50-4317-a0e9-8c6984bdba05)

please copy the repository link below in ***Custom repositories*** section.

```link
https://github.com/chorty/mqtt_vacuum_camera.git
```
...
![Screenshot 2023-08-30 at 07 23 30](https://github.com/chorty/mqtt_vacuum_camera/assets/82227818/5587ecc0-859e-4bd4-ba18-0f96df0c55a5)
...
![Screenshot 2023-08-30 at 07 32 54](https://github.com/chorty/valetudo_vacuum_camera/assets/82227818/c4c054a5-e021-4c68-804b-9484d35a42ae)
...
wget https://github.com/chorty/mqtt_vacuum_camera/archive/refs/tags/v.1.5.9.zip
...
![Screenshot 2023-10-24 at 18 25 59](https://github.com/chorty/valetudo_vacuum_camera/assets/82227818/080b7bcb-19f1-4415-870f-2285329e7ce9)
...
- [**Image Options**](https://github.com/chorty/mqtt_vacuum_camera/blob/main/docs/images_options.md)
- [**Configure Status Text**](https://github.com/chorty/mqtt_vacuum_camera/blob/main/docs/status_text.md)
- [**Configure the Colours**](https://github.com/chorty/mqtt_vacuum_camera/blob/main/docs/colours.md)
- [**Export the logs of this integration**](https://github.com/chorty/mqtt_vacuum_camera/blob/main/docs/snapshots.md)
